...
values = {
    ...
    'bombBoldText':'BOMB',
    'bombText':'Bomb',
    'bsRemoteConfigureInAppText':'BombSquad Remote är konfigurerad i appen själv',
    'buttonText':'Knapp',
    ...
    'connectMobileDevicesWindow':{
        ...
        'explanationText':('För att använda en smartphone eller tablet som styrenhet,\n'
                           'installera appen "BombSquad Remote". Obegränsat antal enheter \n'
                           'kan anslutas för spel över wifi och det är gratis!'),
        'forAndroidText':'för Android:',
        'forIOSText':'för iOS:',
        'getItForText':('Hämta BombSquad Remote för iOS i Apple App Store\n'
    ...
    'creditsWindow':{
        ...
        'titleText':'BombSquad eftertexter',
    ...
    'editProfileWindow':{
        'accountProfileInfoText':('Det här är en speciell spelarprofil med namn och \n'
                                  'ikon baserad på ditt nuvarande konto.\n'
                                  '\n'
                                  '${ICONS}\n'
                                  '\n'
                                  'Skapa speciella profiler om du vill använda \n'
                                  'olika namn eller specialtillverkade ikoner.'),
    ...
    'gatherWindow':{
        ...
        'appInviteMessageText':'${NAME} skickade ${COUNT} biljetter till dig',
        'appInviteSendACodeText':'Skicka en kod till dem..',
        'appInviteTitleText':'Inbjudan att ladda ner BombSquad',
        ...
        'friendHasSentPromoCodeText':'${COUNT} BombSquad-biljetter från ${NAME}',
        ...
        'wifiDirectDescriptionBottomText':('Om alla enheter har en \'Wi-Fi Direct\' panel, borde de kunna använda den för att hitta\n'
                                           ...
                                           '\n'
                                           'För bästa resultat bör Wi-Fi Direct värden även vara BombSquad sällskapsvärd.'),
        ...
        'youHaveBeenSentAPromoCodeText':'Du har fått en promotion kod för BombSquad:'
    },
    'getCoinsWindow':{
    ...
    'helpWindow':{
        ...
        'canHelpText':'BombSquad kan hjälpa',
        'controllersInfoText':('Du kan spela BombSquad med vänner över nätverk, eller så\n'
                               'kan alla spela på samma enhet om du har tillräckligt med styrenheter.\n'
                               'BombSquad stöder en uppsjö av dem; du kan till och med använda\n'
                               'mobiler som enheter via gratisappen \'BombSquad Remote\'.\n'
        ...
        'controlsSubtitleText':'Din vänliga BombSquad-karaktär har några grundläggande handlingar:',
        'controlsText':'Kontroller',
        'devicesInfoText':('VR versionen av BombSquad kan spelas över nätverk med en vanlig\n'
        ...
        'devicesText':'Enheter',
        'friendsGoodText':('Dessa är bra att ha. BombSquad är roligast med flera spelare\n'
        ...
        'welcomeText':'Välkommen till BombSquad!'
    },
