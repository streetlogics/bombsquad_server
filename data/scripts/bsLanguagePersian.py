...
values = {
    ...
    'store':{
        ...
        'bombSquadProNewDescriptionText':('تبلیغات داخل بازی را حذف کنید\n'
                                          ':همچنین شامل میشود'),
        'buyText':'خرید',
